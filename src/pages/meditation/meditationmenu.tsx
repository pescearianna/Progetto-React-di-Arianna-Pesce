          ...
          <section key={med.key}>
            ...
            {med.key === -1 ? ( 
              ...
              <div className="setting-time">
                <button onClick={() => adjustTime(setPersonalH, "add")}>+</button>
                {String(personalH).padStart(2, "0")}
                <button onClick={() => adjustTime(setPersonalH, "sub")}>-</button>
              </div>
              <p>:</p>
              <div className="setting-time">
                <button onClick={() => adjustTime(setPersonalM, "add")}>+</button>
                {String(personalM).padStart(2, "0")}
                <button onClick={() => adjustTime(setPersonalM, "sub")}>-</button>
              </div>
              <p>:</p>
              <div className="setting-time">
                <button onClick={() => adjustTime(setPersonalS, "add")}>+</button>
                {String(personalS).padStart(2, "0")}
                <button onClick={() => adjustTime(setPersonalS, "sub")}>-</button>
              </div>
        </div>
            ) : (
